            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-4">
                        ...
                        <p>This Website is Developed By Sandesh Phuyal <b></b></p>
                    ...
                    <div className="col-md-4">
                        ...
                        <p>kathmandu nepal</p>
                        <p>Email: sandeshphuyal10@gmail.com</p>
                        <p>Phone: 9861499506</p>
                    </div>
                </div>
            </div>
            <div className="container mt-3">
                <div className="row">
                    <div className="col-md-6">
                        <p>&copy; 2023 <b>FoodyWeb</b>, Inc. All rights reserved.</p>
                    </div>
